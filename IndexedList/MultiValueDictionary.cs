...
namespace IndexedList
{
        ...
        IReadOnlyDictionary<TKey, IReadOnlyCollection<TValue>>
    {
        ...
        ** Constructors
        ...
        {
            if (capacity < 0)
                throw new ArgumentOutOfRangeException(nameof(capacity), "Argument needs to be non-negative");
            ...
            IReadOnlyCollection<TValue>
        {
            ...
            ** Shared API
            ...
            public void CopyTo(TValue[] array, int arrayIndex)
            {
                ...
                if (arrayIndex < 0)
                    throw new ArgumentOutOfRangeException(nameof(arrayIndex), "Argument needs to be non-negative");
                if (arrayIndex > array.Length)
                    throw new ArgumentOutOfRangeException(nameof(arrayIndex), "Index out of range");
                if (array.Length - arrayIndex < _collection.Count)
                    throw new ArgumentException("Target out of range", nameof(arrayIndex));
